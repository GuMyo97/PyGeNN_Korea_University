...
//----------------------------------------------------------------------------
CodeGenerator::NeuronSpikeQueueUpdateGroupMerged::NeuronSpikeQueueUpdateGroupMerged(size_t index, std::vector<std::reference_wrapper<const NeuronGroupInternal>> groups,
                                                                                    const CodeGenerator::ModelSpecMerged &modelSpec, const CodeGenerator::BackendBase &backend)
:   CodeGenerator::GroupMerged<NeuronGroupInternal>(index, "NeuronSpikeQueueUpdate", groups)
{
    if(getArchetype().isDelayRequired()) {
...
//----------------------------------------------------------------------------
CodeGenerator::SynapseConnectivityInitGroupMerged::SynapseConnectivityInitGroupMerged(size_t index, std::vector<std::reference_wrapper<const GroupInternal>> groups,
                                                                                      const CodeGenerator::ModelSpecMerged &modelSpec, const CodeGenerator::BackendBase &backend)
:   GroupMerged<SynapseGroupInternal>(index, "SynapseConnectivityInit", groups)
{
    addField("unsigned int", "numSrcNeurons",
             [](const SynapseGroupInternal &sg, size_t) { return std::to_string(sg.getSrcNeuronGroup()->getNumNeurons()); });
    addField("unsigned int", "numTrgNeurons",
...
//----------------------------------------------------------------------------
CodeGenerator::SynapseDendriticDelayUpdateGroupMerged::SynapseDendriticDelayUpdateGroupMerged(size_t index, std::vector<std::reference_wrapper<const GroupInternal>> groups,
                                                                                              const CodeGenerator::ModelSpecMerged &modelSpec, const CodeGenerator::BackendBase &backend)
:   GroupMerged<SynapseGroupInternal>(index, "SynapseDendriticDelayUpdate", groups)
{
    addField("volatile unsigned int*", "denDelayPtr",
             [&backend](const SynapseGroupInternal &sg, size_t)
             {
