...
.. _doxid-d4/d11/class_current_source:
...
.. ref-code-block:: cpp
	...
	public:
		...
		:target:`CurrentSource<doxid-d4/d11/class_current_source_1a23699d48b18506030c0d5afdf72ffd20>`(const CurrentSource&);
		:target:`CurrentSource<doxid-d4/d11/class_current_source_1a837a3749724b52ad1ab76751b2464c21>`();
		...
		const std::string& :target:`getName<doxid-d4/d11/class_current_source_1a4efd934fc92578118b4a7935051071ab>`() const;
		...
		const std::vector<double>& :target:`getParams<doxid-d4/d11/class_current_source_1aafd49bcc780ba345747091af04d72885>`() const;
		const std::vector<:ref:`Models::VarInit<doxid-de/d2a/class_models_1_1_var_init>`>& :target:`getVarInitialisers<doxid-d4/d11/class_current_source_1aab4ea708233ebab9f90876d4c5def063>`() const;
...
.. _details-d4/d11/class_current_source:
...
.. _doxid-d4/d11/class_current_source_1aed244c33e6e0830d203f462d71cd949e:
...
.. _doxid-d4/d11/class_current_source_1a43687bec0ce75867db3661b587e2b6b9:
...
.. _doxid-d4/d11/class_current_source_1adede32230bc2e0264ae6562f5cdc7272:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	const :ref:`CurrentSourceModels::Base<doxid-d8/d1e/class_current_source_models_1_1_base>`* getCurrentSourceModel() const

Gets the current source model used by this group.

.. index:: pair: function; getVarLocation
.. _doxid-d4/d11/class_current_source_1aaa778782b59a8cb3e88b59644c7fd4ba:
...
.. index:: pair: function; getVarLocation
.. _doxid-d4/d11/class_current_source_1a68dd0c0732470342dc8392309a471207:
...
.. _doxid-d4/d11/class_current_source_1a06d4317ea9bf386dbab1d4730f4558f6:
...
.. index:: pair: function; getExtraGlobalParamLocation
.. _doxid-d4/d11/class_current_source_1ab723e7326963f12bbdd05da760bf579b:
