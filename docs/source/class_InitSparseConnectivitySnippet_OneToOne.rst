...
.. _doxid-dc/d5c/class_init_sparse_connectivity_snippet_1_1_one_to_one:
...
.. ref-code-block:: cpp
	...
	class OneToOne: public :ref:`InitSparseConnectivitySnippet::Base<doxid-d8/d82/class_init_sparse_connectivity_snippet_1_1_base>`
	{
	public:
		// methods
	
		:target:`DECLARE_SNIPPET<doxid-dc/d5c/class_init_sparse_connectivity_snippet_1_1_one_to_one_1a8cdbf3d3faa0645465813674ddd9beed>`(
			InitSparseConnectivitySnippet::OneToOne,
			0
			);
	
		:target:`SET_ROW_BUILD_CODE<doxid-dc/d5c/class_init_sparse_connectivity_snippet_1_1_one_to_one_1ac1f11dbe726beeccc1f877aea00a1928>`("$(addSynapse, $(id_pre));\n""$(endRow);\n");
		:target:`SET_MAX_ROW_LENGTH<doxid-dc/d5c/class_init_sparse_connectivity_snippet_1_1_one_to_one_1a8b0dac1b1056ac7aea98d1b108252314>`(1);
		:target:`SET_MAX_COL_LENGTH<doxid-dc/d5c/class_init_sparse_connectivity_snippet_1_1_one_to_one_1a84265bb1cfe611cacd4c3ceba26215ef>`(1);
	};
