...
.. _doxid-da/da2/class_neuron_models_1_1_traub_miles_alt:
...
Hodgkin-Huxley neurons with Traub & Miles algorithm. :ref:`More...<details-da/da2/class_neuron_models_1_1_traub_miles_alt>`
...
.. ref-code-block:: cpp
	...
	class TraubMilesAlt: public :ref:`NeuronModels::TraubMiles<doxid-d6/d4a/class_neuron_models_1_1_traub_miles>`
	{
	public:
		// typedefs
	
		typedef :ref:`Snippet::ValueBase<doxid-db/dd1/class_snippet_1_1_value_base>`<7> :target:`ParamValues<doxid-da/da2/class_neuron_models_1_1_traub_miles_alt_1a5d71461d6e76cc357c4e48df364c5478>`;
		typedef :ref:`Models::VarInitContainerBase<doxid-d8/d31/class_models_1_1_var_init_container_base>`<4> :target:`VarValues<doxid-da/da2/class_neuron_models_1_1_traub_miles_alt_1a3da9ad33bc11ee84dee6853bd14776d1>`;
		typedef :ref:`Models::VarInitContainerBase<doxid-d8/d31/class_models_1_1_var_init_container_base>`<0> :target:`PreVarValues<doxid-da/da2/class_neuron_models_1_1_traub_miles_alt_1aa54e3356d02d600123b3ae4da9d27db5>`;
		typedef :ref:`Models::VarInitContainerBase<doxid-d8/d31/class_models_1_1_var_init_container_base>`<0> :target:`PostVarValues<doxid-da/da2/class_neuron_models_1_1_traub_miles_alt_1acd5c2471f44cf245d7d7807ed4cb7c49>`;

		// methods
	
		static const NeuronModels::TraubMilesAlt* :target:`getInstance<doxid-da/da2/class_neuron_models_1_1_traub_miles_alt_1aaba12e49ac76b945a8678fc03a44a914>`();
		virtual std::string :ref:`getSimCode<doxid-da/da2/class_neuron_models_1_1_traub_miles_alt_1a880d0af5b1bb49eecfd0bee29716a8aa>`() const;
	};
...
.. _details-da/da2/class_neuron_models_1_1_traub_miles_alt:
...
.. _doxid-da/da2/class_neuron_models_1_1_traub_miles_alt_1a880d0af5b1bb49eecfd0bee29716a8aa:
