...
.. _doxid-d5/da3/class_postsynaptic_models_1_1_delta_curr:
...
Simple delta current synapse. :ref:`More...<details-d5/da3/class_postsynaptic_models_1_1_delta_curr>`
...
.. ref-code-block:: cpp
	...
	class DeltaCurr: public :ref:`PostsynapticModels::Base<doxid-d3/d2d/class_postsynaptic_models_1_1_base>`
	{
	public:
		// typedefs
	
		typedef :ref:`Snippet::ValueBase<doxid-db/dd1/class_snippet_1_1_value_base>`<0> :target:`ParamValues<doxid-d5/da3/class_postsynaptic_models_1_1_delta_curr_1ac79a926831d8a70e524f3a1c57672bd9>`;
		typedef :ref:`Models::VarInitContainerBase<doxid-d8/d31/class_models_1_1_var_init_container_base>`<0> :target:`VarValues<doxid-d5/da3/class_postsynaptic_models_1_1_delta_curr_1ad44a55e6f4aa03b4a6e1986bddf39601>`;
		typedef :ref:`Models::VarInitContainerBase<doxid-d8/d31/class_models_1_1_var_init_container_base>`<0> :target:`PreVarValues<doxid-d5/da3/class_postsynaptic_models_1_1_delta_curr_1a3df3b2a0591f9c0f40871157ef9868f6>`;
		typedef :ref:`Models::VarInitContainerBase<doxid-d8/d31/class_models_1_1_var_init_container_base>`<0> :target:`PostVarValues<doxid-d5/da3/class_postsynaptic_models_1_1_delta_curr_1ae64a7f09da43d6d3d08f964df89626a0>`;

		// methods
	
		static const DeltaCurr* :target:`getInstance<doxid-d5/da3/class_postsynaptic_models_1_1_delta_curr_1a4ed81c3ad0a14f46b7a2dad1f9b7992f>`();
		virtual std::string :target:`getApplyInputCode<doxid-d5/da3/class_postsynaptic_models_1_1_delta_curr_1a4ed0d483fa452dd7405aced6dddf3a12>`() const;
	};
...
.. _details-d5/da3/class_postsynaptic_models_1_1_delta_curr:
