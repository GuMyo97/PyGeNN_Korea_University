...
.. _doxid-db/dfd/class_neuron_models_1_1_traub_miles_n_step:
...
Hodgkin-Huxley neurons with Traub & Miles algorithm. :ref:`More...<details-db/dfd/class_neuron_models_1_1_traub_miles_n_step>`
...
.. ref-code-block:: cpp
	...
	class TraubMilesNStep: public :ref:`NeuronModels::TraubMiles<doxid-d6/d4a/class_neuron_models_1_1_traub_miles>`
	{
	public:
		// typedefs
	
		typedef :ref:`Snippet::ValueBase<doxid-db/dd1/class_snippet_1_1_value_base>`<8> :target:`ParamValues<doxid-db/dfd/class_neuron_models_1_1_traub_miles_n_step_1a8c6b523af9ed2dfea72430d67f9add27>`;
		typedef :ref:`Models::VarInitContainerBase<doxid-d8/d31/class_models_1_1_var_init_container_base>`<4> :target:`VarValues<doxid-db/dfd/class_neuron_models_1_1_traub_miles_n_step_1a55b5664bf554d2cb756710afa41827ce>`;
		typedef :ref:`Models::VarInitContainerBase<doxid-d8/d31/class_models_1_1_var_init_container_base>`<0> :target:`PreVarValues<doxid-db/dfd/class_neuron_models_1_1_traub_miles_n_step_1a9f568788f62b60db89c8ba974e5b34f8>`;
		typedef :ref:`Models::VarInitContainerBase<doxid-d8/d31/class_models_1_1_var_init_container_base>`<0> :target:`PostVarValues<doxid-db/dfd/class_neuron_models_1_1_traub_miles_n_step_1ab869013d2202d2925e89cfaae2ae2f1f>`;

		// methods
	
		static const NeuronModels::TraubMilesNStep* :target:`getInstance<doxid-db/dfd/class_neuron_models_1_1_traub_miles_n_step_1ab12c675d63cc4af1b9f670bc96df8a9f>`();
		virtual std::string :ref:`getSimCode<doxid-db/dfd/class_neuron_models_1_1_traub_miles_n_step_1aa2ccbc5e48419de3ad2494f3a19dc1ba>`() const;
		virtual :ref:`StringVec<doxid-d6/df7/class_snippet_1_1_base_1a06cd0f6da1424a20163e12b6fec62519>` :ref:`getParamNames<doxid-db/dfd/class_neuron_models_1_1_traub_miles_n_step_1aaf02c5cf52bb457e2cc8aacd9ec13c7e>`() const;
	};
...
.. _details-db/dfd/class_neuron_models_1_1_traub_miles_n_step:
...
Same as standard :ref:`TraubMiles <doxid-d6/d4a/class_neuron_models_1_1_traub_miles>` model but number of inner loops can be set using a parameter

Methods
-------

.. index:: pair: function; getSimCode
.. _doxid-db/dfd/class_neuron_models_1_1_traub_miles_n_step_1aa2ccbc5e48419de3ad2494f3a19dc1ba:
...
.. _doxid-db/dfd/class_neuron_models_1_1_traub_miles_n_step_1aaf02c5cf52bb457e2cc8aacd9ec13c7e:
