...
.. _doxid-d1/d8d/class_postsynaptic_models_1_1_exp_curr:
...
Exponential decay with synaptic input treated as a current value. :ref:`More...<details-d1/d8d/class_postsynaptic_models_1_1_exp_curr>`
...
.. ref-code-block:: cpp
	...
	class ExpCurr: public :ref:`PostsynapticModels::Base<doxid-d3/d2d/class_postsynaptic_models_1_1_base>`
	{
	public:
		// typedefs
	
		typedef :ref:`Snippet::ValueBase<doxid-db/dd1/class_snippet_1_1_value_base>`<1> :target:`ParamValues<doxid-d1/d8d/class_postsynaptic_models_1_1_exp_curr_1ad30dc0939458f4b258facbab84a83b3b>`;
		typedef :ref:`Models::VarInitContainerBase<doxid-d8/d31/class_models_1_1_var_init_container_base>`<0> :target:`VarValues<doxid-d1/d8d/class_postsynaptic_models_1_1_exp_curr_1aa34e3f94e243295537c684f0c3f6eaad>`;
		typedef :ref:`Models::VarInitContainerBase<doxid-d8/d31/class_models_1_1_var_init_container_base>`<0> :target:`PreVarValues<doxid-d1/d8d/class_postsynaptic_models_1_1_exp_curr_1ac136b34dfafa22ad131aa8ce522a4a12>`;
		typedef :ref:`Models::VarInitContainerBase<doxid-d8/d31/class_models_1_1_var_init_container_base>`<0> :target:`PostVarValues<doxid-d1/d8d/class_postsynaptic_models_1_1_exp_curr_1a13b9ec21322cb9db92ca490949ddefa6>`;

		// methods
	
		static const ExpCurr* :target:`getInstance<doxid-d1/d8d/class_postsynaptic_models_1_1_exp_curr_1a76c6e6548b00a2b630d28c54fa2e6f8d>`();
		virtual std::string :target:`getDecayCode<doxid-d1/d8d/class_postsynaptic_models_1_1_exp_curr_1ab8eb9a53898579c5d16b64a07901b9dd>`() const;
		virtual std::string :target:`getApplyInputCode<doxid-d1/d8d/class_postsynaptic_models_1_1_exp_curr_1a6e85c8dbf187916807951d162d984a27>`() const;
		virtual :ref:`StringVec<doxid-d6/df7/class_snippet_1_1_base_1a06cd0f6da1424a20163e12b6fec62519>` :ref:`getParamNames<doxid-d1/d8d/class_postsynaptic_models_1_1_exp_curr_1a44f8c01c1a6d89292701c410796c5be9>`() const;
		virtual :ref:`DerivedParamVec<doxid-d6/df7/class_snippet_1_1_base_1ad14217cebf11eddffa751a4d5c4792cb>` :ref:`getDerivedParams<doxid-d1/d8d/class_postsynaptic_models_1_1_exp_curr_1a0382c6f54349cd1e332cd5f4f82ec752>`() const;
	};
...
.. _details-d1/d8d/class_postsynaptic_models_1_1_exp_curr:
...
.. _doxid-d1/d8d/class_postsynaptic_models_1_1_exp_curr_1a44f8c01c1a6d89292701c410796c5be9:
...
.. _doxid-d1/d8d/class_postsynaptic_models_1_1_exp_curr_1a0382c6f54349cd1e332cd5f4f82ec752:
