...
.. _doxid-d7/dd5/class_model_spec_internal:
...
.. ref-code-block:: cpp
	...
	class ModelSpecInternal: public :ref:`ModelSpec<doxid-d1/de7/class_model_spec>`
	{
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		typedef std::map<std::string, :ref:`NeuronGroupInternal<doxid-d1/dc9/class_neuron_group_internal>`>::value_type :ref:`NeuronGroupValueType<doxid-d1/de7/class_model_spec_1ac724c12166b5ee5fb4492277c1d8deb5>`;
		typedef std::map<std::string, :ref:`SynapseGroupInternal<doxid-d7/d53/class_synapse_group_internal>`>::value_type :ref:`SynapseGroupValueType<doxid-d1/de7/class_model_spec_1a8af14d4e037788bb97854c4d0da801df>`;

		// methods
	
		:ref:`ModelSpec<doxid-d1/de7/class_model_spec_1a5f71e866bd0b2af2abf2b1e8dde7d6d4>`();
		:ref:`ModelSpec<doxid-d1/de7/class_model_spec_1ab5f3d20c830593a4452be5878e43bba8>`(const :ref:`ModelSpec<doxid-d1/de7/class_model_spec>`&);
		:ref:`ModelSpec<doxid-d1/de7/class_model_spec>`& :ref:`operator =<doxid-d1/de7/class_model_spec_1aaf415f0379159d74d57d18126cf2982e>` (const :ref:`ModelSpec<doxid-d1/de7/class_model_spec>`&);
		:ref:`~ModelSpec<doxid-d1/de7/class_model_spec_1a60ffaa6deb779cff61da6a7ea651613f>`();
